...
With embedded urls: ( download the hardcoded list of files in the 'files =' block below)
    ...
    python ./download-all-2026-08-09_11-00-44.py

Download all files in a Metalink/CSV: (downloaded from ASF Vertex)

    python ./download-all-2026-08-09_11-00-44.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
...
class bulk_downloader:
    def __init__(self):
        ...
        self.files = [ "https://nisar.asf.earthdatacloud.nasa.gov/NISAR/NISAR_L2_GCOV_PROVISIONAL_V1/NISAR_L2_PR_GCOV_026_055_A_011_4005_DHDH_A_20260724T000130_20260724T000204_P05023_N_F_J_001/NISAR_L2_PR_GCOV_026_055_A_011_4005_DHDH_A_20260724T000130_20260724T000204_P05023_N_F_J_001.h5",
                       "https://nisar.asf.earthdatacloud.nasa.gov/NISAR/NISAR_L2_GCOV_BETA_V1/NISAR_L2_PR_GCOV_009_055_A_011_4005_DHDH_A_20260101T000132_20260101T000206_X05009_N_F_J_001/NISAR_L2_PR_GCOV_009_055_A_011_4005_DHDH_A_20260101T000132_20260101T000206_X05009_N_F_J_001.h5" ]
        ...
        for cookie in cj:
            if cookie.name in ["urs_user_already_logged", "asf-urs"]:
                if cookie.name == "asf-urs":
                    try:
                        asf_cookie = self.get_decoded_cookie(cookie.value)
                        urs_cookie = self.get_decoded_cookie(asf_cookie['urs-access-token'])
                        if urs_cookie['exp'] <= time.time():
                            return False
                    except IndexError:
                        return False
    ...
    def get_decoded_cookie(self, cookie):
        encoded_str = cookie.split('.')[1]
        encoded_str += "=" * ((4 - len(encoded_str) % 4) % 4) # sometimes base64 decode throws a padding error
